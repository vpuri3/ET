...
iteration = zeros(1,it_jacobi+it_newton*it_srj+1);
residual = zeros(1,it_jacobi+it_newton*it_srj+1);
residual (1) = res;
...
count=1; % Count
while count <= it_newton
    disp(['Newton Raphson Step ' num2str(count)])
    delU = zeros(n+1,n+1,n+1);
    laplaceU0 = U0;
