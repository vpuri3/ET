...
while count <= it_linear
    ...
    laplaceU0 = U0;
    laplaceU0(2:n,2:n,2:n) = nsq*(U0(1:n-1,2:n,2:n)+U0(3:n+1,2:n,2:n)+U0(2:n,1:n-1,2:n)+U0(2:n,3:n+1,2:n)+U0(2:n,2:n,1:n-1)+U0(2:n,2:n,3:n+1)-6*U0(2:n,2:n,2:n));
    Rv = -0.125*(Asq).*((C+U0).^(-7)-7*((C+U0).^(-8)).*delU)-laplaceU0;
    Tv = T - U0;
    ...
    while k <= it_srj
        ...
        Rv = -0.125*(asq).*((C+U0).^(-7)-7*((C+U0).^(-8)).*delU)-laplaceU0; % update RHS
        k = k+1;
    end
